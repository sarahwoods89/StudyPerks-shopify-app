...
export const loader = async ({ request, params }) => {
  ...
  return json({ shop, transactions, totalOrders, totalRevenue, totalCommission });
};
...
export default function MerchantDetail() {
  const { shop, transactions, totalOrders, totalRevenue, totalCommission } = useLoaderData();
          ...
          <table style={s.table}>
            ...
            <tbody>
              ...
              {transactions.length === 0 && (
                <tr><td style={s.td} colSpan={4}>No orders yet for this merchant.</td></tr>
              )}
            </tbody>
          </table>
        </div>
